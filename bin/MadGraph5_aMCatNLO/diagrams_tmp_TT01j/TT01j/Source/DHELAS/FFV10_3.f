...
C     
     ...
     $ *P3(0)))
      TMP109 = (F1(5)*-F2(5)*(P3(1)*P3(1)+P3(2)*P3(2)+P3(3)*P3(3)-P3(0)
     $ *P3(0))-F1(6)*F2(6)*(P3(1)*P3(1)+P3(2)*P3(2)+P3(3)*P3(3)-P3(0)
     $ *P3(0)))
      DENOM = COUP/(P3(0)**2-P3(1)**2-P3(2)**2-P3(3)**2 - M3 * (M3 -CI
     $ * W3))
      V3(3)= DENOM*2D0 * CI*(F1(5)*(F2(6)*(P3(1)+CI*(P3(2)))+F2(5)
     $ *P3(3))+(+1D0/2D0*(OM3*P3(0)*(TMP109-TMP9))+F1(6)*(F2(5)*(P3(1)
     $ -CI*(P3(2)))-F2(6)*P3(3))))
      V3(4)= DENOM*2D0 * CI*(F1(5)*(F2(6)*(P3(0)-P3(3))-CI*(F2(5)*P3(2)
     $ ))+(+1D0/2D0*(OM3*P3(1)*(TMP109-TMP9))+F1(6)*(F2(5)*(P3(0)+P3(3)
     $ )+CI*(F2(6)*P3(2)))))
      V3(5)= DENOM*2D0*(F1(5)*(F2(6)*(P3(3)-P3(0))-F2(5)*P3(1))+(+1D0
     $ /2D0*(OM3*P3(2)*(-CI*(TMP9)+CI*(TMP109)))+F1(6)*(F2(5)*(P3(0)
     $ +P3(3))+F2(6)*P3(1))))
      V3(6)= DENOM*2D0 * CI*(F1(5)*(F2(6)*(P3(1)+CI*(P3(2)))+F2(5)
     $ *P3(0))+(+1D0/2D0*(OM3*P3(3)*(TMP109-TMP9))+F1(6)*(F2(5)*(+CI
     $ *(P3(2))-P3(1))-F2(6)*P3(0))))
      END
