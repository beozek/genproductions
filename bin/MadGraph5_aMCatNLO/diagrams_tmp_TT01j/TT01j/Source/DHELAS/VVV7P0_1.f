...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(P2(0)*(-CI*(TMP28*TMP48)+CI*(TMP23*TMP27))+(P3(0)
     $ *(-CI*(TMP24*TMP25)+CI*(TMP28*TMP69))+(TMP38*(-CI*(V2(3)*TMP23)
     $ +CI*(V3(3)*TMP25))+(-CI*(V3(3)*TMP27*TMP69)+CI*(V2(3)*TMP24
     $ *TMP48)))))
      V1(4)= DENOM*(P2(1)*(-CI*(TMP28*TMP48)+CI*(TMP23*TMP27))+(P3(1)
     $ *(-CI*(TMP24*TMP25)+CI*(TMP28*TMP69))+(TMP38*(-CI*(V2(4)*TMP23)
     $ +CI*(V3(4)*TMP25))+(-CI*(V3(4)*TMP27*TMP69)+CI*(V2(4)*TMP24
     $ *TMP48)))))
      V1(5)= DENOM*(P2(2)*(-CI*(TMP28*TMP48)+CI*(TMP23*TMP27))+(P3(2)
     $ *(-CI*(TMP24*TMP25)+CI*(TMP28*TMP69))+(TMP38*(-CI*(V2(5)*TMP23)
     $ +CI*(V3(5)*TMP25))+(-CI*(V3(5)*TMP27*TMP69)+CI*(V2(5)*TMP24
     $ *TMP48)))))
      V1(6)= DENOM*(P2(3)*(-CI*(TMP28*TMP48)+CI*(TMP23*TMP27))+(P3(3)
     $ *(-CI*(TMP24*TMP25)+CI*(TMP28*TMP69))+(TMP38*(-CI*(V2(6)*TMP23)
     $ +CI*(V3(6)*TMP25))+(-CI*(V3(6)*TMP27*TMP69)+CI*(V2(6)*TMP24
     $ *TMP48)))))
      END
