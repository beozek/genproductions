...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(-CI*(V4(3)*TMP28)+CI*(V2(3)*TMP40))
      V1(4)= DENOM*(-CI*(V4(4)*TMP28)+CI*(V2(4)*TMP40))
      V1(5)= DENOM*(-CI*(V4(5)*TMP28)+CI*(V2(5)*TMP40))
      V1(6)= DENOM*(-CI*(V4(6)*TMP28)+CI*(V2(6)*TMP40))
      END
