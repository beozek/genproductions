...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(-CI*(V4(3)*TMP28)+CI*(V3(3)*TMP37))
      V1(4)= DENOM*(-CI*(V4(4)*TMP28)+CI*(V3(4)*TMP37))
      V1(5)= DENOM*(-CI*(V4(5)*TMP28)+CI*(V3(5)*TMP37))
      V1(6)= DENOM*(-CI*(V4(6)*TMP28)+CI*(V3(6)*TMP37))
      END
