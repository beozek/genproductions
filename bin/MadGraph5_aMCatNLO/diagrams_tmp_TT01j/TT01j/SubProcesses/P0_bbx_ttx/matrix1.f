...
C     
C     Process: b b~ > t t~ NP<=1 NPprop=0 SMHLOOP=0
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFFF12_2_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_88,GC_87,AMP(1))
      CALL FFFF1_10_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_88,-GC_87,AMP(2))
C     Amplitude(s) for diagram number 2
      CALL FFFF14_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_82,AMP(3))
C     Amplitude(s) for diagram number 3
      CALL FFFF16_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_62,AMP(4))
C     Amplitude(s) for diagram number 4
      CALL FFFF15_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_93,AMP(5))
C     Amplitude(s) for diagram number 5
      CALL FFFF12_2_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_84,GC_83,AMP(6))
      CALL FFFF1_10_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_84,-GC_83,AMP(7))
C     Amplitude(s) for diagram number 6
      CALL FFFF14_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_81,AMP(8))
C     Amplitude(s) for diagram number 7
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_79,AMP(9))
C     Amplitude(s) for diagram number 8
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_80,AMP(10))
C     Amplitude(s) for diagram number 9
      CALL FFFF15_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_94,AMP(11))
C     Amplitude(s) for diagram number 10
      CALL FFFF16_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_63,AMP(12))
C     Amplitude(s) for diagram number 11
      CALL FFFF27_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_85,AMP(13))
      CALL FFFF112_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_86,AMP(14))
C     Amplitude(s) for diagram number 12
      CALL FFFF27_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_89,AMP(15))
      CALL FFFF112_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_90,AMP(16))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_353,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(17))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_357,AMP(18))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(19))
C     Amplitude(s) for diagram number 16
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_358,AMP(20))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_451,AMP(21))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_463,AMP(22))
C     Amplitude(s) for diagram number 19
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_452,AMP(23))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_473,AMP(24))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_484,AMP(25))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_531,AMP(26))
      CALL FFV9P0_3(W(1,1),W(1,2),GC_354,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(27))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_439,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(28))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_462,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(29))
      CALL FFV9P0_3(W(1,1),W(1,2),GC_440,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(30))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_472,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(31))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_483,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(32))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_530,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(33))
      CALL FFV2_3(W(1,1),W(1,2),GC_355,MDL_MZ, FK_MDL_WZ,W(1,5))
...
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_367,AMP(35))
C     Amplitude(s) for diagram number 32
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(36))
C     Amplitude(s) for diagram number 33
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_369,AMP(37))
C     Amplitude(s) for diagram number 34
      CALL FFV7_0(W(1,4),W(1,3),W(1,5),GC_512,AMP(38))
C     Amplitude(s) for diagram number 35
      CALL FFV5_0(W(1,4),W(1,3),W(1,5),GC_524,AMP(39))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_441,AMP(40))
C     Amplitude(s) for diagram number 37
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_442,AMP(41))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_467,AMP(42))
C     Amplitude(s) for diagram number 39
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_520,AMP(43))
C     Amplitude(s) for diagram number 40
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_521,AMP(44))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_541,AMP(45))
C     Amplitude(s) for diagram number 42
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_522,AMP(46))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_544,AMP(47))
C     Amplitude(s) for diagram number 44
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_547,GC_526,AMP(48))
      CALL FFV9_3(W(1,1),W(1,2),GC_356,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 45
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(49))
      CALL FFV8_3(W(1,1),W(1,2),GC_510,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 46
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(50))
      CALL FFV5_3(W(1,1),W(1,2),GC_508,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 47
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(51))
      CALL FFV2_3(W(1,1),W(1,2),GC_437,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 48
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(52))
      CALL FFV9_3(W(1,1),W(1,2),GC_438,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 49
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(53))
      CALL FFV1_3(W(1,1),W(1,2),GC_466,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 50
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(54))
      CALL FFV3_3(W(1,1),W(1,2),GC_519,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 51
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(55))
      CALL FFV3_3(W(1,1),W(1,2),GC_521,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 52
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(56))
      CALL FFV1_3(W(1,1),W(1,2),GC_540,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 53
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(57))
      CALL FFV3_3(W(1,1),W(1,2),GC_523,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 54
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(58))
      CALL FFV1_3(W(1,1),W(1,2),GC_543,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 55
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(59))
      CALL FFV1_3_3(W(1,1),W(1,2),GC_546,GC_527,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
C     Amplitude(s) for diagram number 56
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(60))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_337,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(61))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 58
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_351,AMP(62))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(63))
C     Amplitude(s) for diagram number 60
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_352,AMP(64))
      CALL FFV9P0_3(W(1,1),W(1,2),GC_338,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(65))
      CALL FFS2_3(W(1,1),W(1,2),GC_458,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 62
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(66))
      CALL FFS1_3(W(1,1),W(1,2),GC_457,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 63
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(67))
      CALL FFS2_3(W(1,1),W(1,2),GC_566,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 64
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_461,AMP(68))
C     Amplitude(s) for diagram number 65
      CALL FFS1_0(W(1,4),W(1,3),W(1,5),GC_460,AMP(69))
C     Amplitude(s) for diagram number 66
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(70))
C     Amplitude(s) for diagram number 67
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1029,AMP(71))
C     Amplitude(s) for diagram number 68
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1030,AMP(72))
C     Amplitude(s) for diagram number 69
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1031,AMP(73))
C     Amplitude(s) for diagram number 70
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1032,AMP(74))
      CALL FFS2_3(W(1,1),W(1,2),GC_568,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 71
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(75))
      CALL FFS2_3(W(1,1),W(1,2),GC_569,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 72
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(76))
      CALL FFS2_3(W(1,1),W(1,2),GC_570,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 73
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(77))
      CALL FFS2_3(W(1,1),W(1,2),GC_571,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 74
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(78))
      CALL FFV3_3(W(1,1),W(1,3),GC_202,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 75
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(79))
C     Amplitude(s) for diagram number 76
      CALL FFV5_0(W(1,4),W(1,2),W(1,5),GC_505,AMP(80))
C     Amplitude(s) for diagram number 77
      CALL FFV10_0(W(1,4),W(1,2),W(1,5),GC_365,AMP(81))
C     Amplitude(s) for diagram number 78
      CALL FFV4_0(W(1,4),W(1,2),W(1,5),GC_342,AMP(82))
C     Amplitude(s) for diagram number 79
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_502,AMP(83))
C     Amplitude(s) for diagram number 80
      CALL FFV5_0(W(1,4),W(1,2),W(1,5),GC_506,AMP(84))
C     Amplitude(s) for diagram number 81
      CALL FFV10_0(W(1,4),W(1,2),W(1,5),GC_368,AMP(85))
C     Amplitude(s) for diagram number 82
      CALL FFV4_0(W(1,4),W(1,2),W(1,5),GC_343,AMP(86))
C     Amplitude(s) for diagram number 83
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_503,AMP(87))
C     Amplitude(s) for diagram number 84
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_507,AMP(88))
      CALL FFV5_3(W(1,1),W(1,3),GC_504,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 85
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(89))
      CALL FFV10_3(W(1,1),W(1,3),GC_341,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 86
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(90))
      CALL FFV4_3(W(1,1),W(1,3),GC_366,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 87
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(91))
      CALL FFV3_3(W(1,1),W(1,3),GC_502,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 88
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(92))
      CALL FFV5_3(W(1,1),W(1,3),GC_506,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 89
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(93))
      CALL FFV10_3(W(1,1),W(1,3),GC_343,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 90
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(94))
      CALL FFV4_3(W(1,1),W(1,3),GC_368,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 91
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(95))
      CALL FFV3_3(W(1,1),W(1,3),GC_503,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 92
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(96))
      CALL FFV3_3(W(1,1),W(1,3),GC_507,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 93
      CALL FFV3_0(W(1,4),W(1,2),W(1,5),GC_202,AMP(97))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*AMP(1)-1D0/6D0*AMP(2)-1D0/6D0*AMP(3)+AMP(4)
     $ +AMP(5)+AMP(7)+AMP(8)+AMP(9)-1D0/6D0*AMP(10)-1D0/6D0*AMP(11)
     $ -1D0/6D0*AMP(12)+AMP(14)+1D0/2D0*AMP(15)-1D0/6D0*AMP(16)-AMP(17)
     ...
     $ -AMP(58)-AMP(59)-AMP(60)+1D0/6D0*AMP(61)+1D0/6D0*AMP(62)+1D0
     $ /6D0*AMP(63)+1D0/6D0*AMP(64)+1D0/6D0*AMP(65)-AMP(66)-AMP(67)
     $ -AMP(68)-AMP(69)-AMP(70)-AMP(71)-AMP(72)-AMP(73)-AMP(74)-AMP(75)
     $ -AMP(76)-AMP(77)-AMP(78)
      JAMP(2,1)=-1D0/6D0*AMP(1)+1D0/2D0*AMP(2)+1D0/2D0*AMP(3)+AMP(6)
     $ +1D0/2D0*AMP(10)+1D0/2D0*AMP(11)+1D0/2D0*AMP(12)+AMP(13)-1D0
     $ /6D0*AMP(15)+1D0/2D0*AMP(16)-1D0/2D0*AMP(61)-1D0/2D0*AMP(62)
     $ -1D0/2D0*AMP(63)-1D0/2D0*AMP(64)-1D0/2D0*AMP(65)+AMP(79)+AMP(80)
     ...
     $ +AMP(97)
      ...
      AMP2(13)=AMP2(13)+(AMP(17)+AMP(18)+AMP(19)+AMP(20)+AMP(21)
     $ +AMP(22)+AMP(23)+AMP(24)+AMP(25)+AMP(26)+AMP(27)+AMP(28)+AMP(29)
     $ +AMP(30)+AMP(31)+AMP(32)+AMP(33))*DCONJG(AMP(17)+AMP(18)+AMP(19)
     $ +AMP(20)+AMP(21)+AMP(22)+AMP(23)+AMP(24)+AMP(25)+AMP(26)+AMP(27)
     $ +AMP(28)+AMP(29)+AMP(30)+AMP(31)+AMP(32)+AMP(33))
      AMP2(30)=AMP2(30)+(AMP(34)+AMP(35)+AMP(36)+AMP(37)+AMP(38)
     $ +AMP(39)+AMP(40)+AMP(41)+AMP(42)+AMP(43)+AMP(44)+AMP(45)+AMP(46)
     $ +AMP(47)+AMP(48)+AMP(49)+AMP(50)+AMP(51)+AMP(52)+AMP(53)+AMP(54)
     $ +AMP(55)+AMP(56)+AMP(57)+AMP(58)+AMP(59)+AMP(60))*DCONJG(AMP(34)
     $ +AMP(35)+AMP(36)+AMP(37)+AMP(38)+AMP(39)+AMP(40)+AMP(41)+AMP(42)
     $ +AMP(43)+AMP(44)+AMP(45)+AMP(46)+AMP(47)+AMP(48)+AMP(49)+AMP(50)
     $ +AMP(51)+AMP(52)+AMP(53)+AMP(54)+AMP(55)+AMP(56)+AMP(57)+AMP(58)
     $ +AMP(59)+AMP(60))
      AMP2(57)=AMP2(57)+(AMP(61)+AMP(62)+AMP(63)+AMP(64)+AMP(65))
     $ *DCONJG(AMP(61)+AMP(62)+AMP(63)+AMP(64)+AMP(65))
      AMP2(62)=AMP2(62)+(AMP(66)+AMP(67)+AMP(68)+AMP(69)+AMP(70)
     $ +AMP(71)+AMP(72)+AMP(73)+AMP(74)+AMP(75)+AMP(76)+AMP(77)+AMP(78)
     $ )*DCONJG(AMP(66)+AMP(67)+AMP(68)+AMP(69)+AMP(70)+AMP(71)+AMP(72)
     $ +AMP(73)+AMP(74)+AMP(75)+AMP(76)+AMP(77)+AMP(78))
      AMP2(75)=AMP2(75)+(AMP(79)+AMP(80)+AMP(81)+AMP(82)+AMP(83)
     $ +AMP(84)+AMP(85)+AMP(86)+AMP(87)+AMP(88)+AMP(89)+AMP(90)+AMP(91)
     $ +AMP(92)+AMP(93)+AMP(94)+AMP(95)+AMP(96)+AMP(97))*DCONJG(AMP(79)
