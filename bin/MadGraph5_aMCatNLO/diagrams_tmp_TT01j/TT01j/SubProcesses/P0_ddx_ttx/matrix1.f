...
C     
C     Process: d d~ > t t~ NP<=1 NPprop=0 SMHLOOP=0
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFFF12_2_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_671,GC_670,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFFF14_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_113,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFFF16_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_64,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFFF1_10_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_679,-GC_678
     $ ,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFFF15_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_95,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFFF12_2_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_667,GC_666,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFFF14_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_112,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_67,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_68,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFFF1_10_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_675,-GC_674
     $ ,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFFF15_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_96,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFFF16_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_65,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFFF27_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_668,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFFF27_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_672,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFFF112_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_681,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFFF112_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_677,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_72,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_69,AMP(18))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_708,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(19))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_357,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_358,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_451,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_463,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_452,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_473,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_484,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_531,AMP(28))
      CALL FFV9P0_3(W(1,1),W(1,2),GC_709,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(29))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_724,ZERO, FK_ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 31
      ...
      CALL FFV9P0_3(W(1,1),W(1,2),GC_725,ZERO, FK_ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(34))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_530,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_2,AMP(35))
      CALL FFV2_3(W(1,1),W(1,2),GC_710,MDL_MZ, FK_MDL_WZ,W(1,5))
...
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_367,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_369,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV7_0(W(1,4),W(1,3),W(1,5),GC_512,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV5_0(W(1,4),W(1,3),W(1,5),GC_524,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_441,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_442,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_467,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_520,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_521,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_541,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_522,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_544,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_547,GC_526,AMP(50))
      CALL FFV9_3(W(1,1),W(1,2),GC_711,MDL_MZ, FK_MDL_WZ,W(1,5))
...
C     Amplitude(s) for diagram number 57
      ...
      CALL FFV3_3(W(1,1),W(1,2),GC_517,MDL_MZ, FK_MDL_WZ,W(1,5))
...
C     Amplitude(s) for diagram number 61
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_264,GC_203,AMP(61))
      CALL FFV2P0_3(W(1,1),W(1,2),GC_701,ZERO, FK_ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 63
      CALL FFV2_0(W(1,4),W(1,3),W(1,5),GC_351,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV9_0(W(1,4),W(1,3),W(1,5),GC_352,AMP(65))
      CALL FFV9P0_3(W(1,1),W(1,2),GC_702,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 66
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_6,AMP(66))
      CALL FFS2_3(W(1,1),W(1,2),GC_652,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 67
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_461,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFS1_0(W(1,4),W(1,3),W(1,5),GC_460,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1029,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1030,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1031,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1032,AMP(73))
      CALL FFS1_3(W(1,1),W(1,2),GC_726,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 74
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(74))
      CALL FFS2_3(W(1,1),W(1,2),GC_727,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 75
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(75))
      CALL FFS2_3(W(1,1),W(1,2),GC_728,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 76
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(76))
      CALL FFS2_3(W(1,1),W(1,2),GC_729,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 77
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(77))
      CALL FFS2_3(W(1,1),W(1,2),GC_730,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 78
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(78))
      CALL FFS2_3(W(1,1),W(1,2),GC_731,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 79
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_1025,AMP(79))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*AMP(1)-1D0/6D0*AMP(2)+AMP(3)-1D0/6D0*AMP(4)
     $ +AMP(5)+AMP(7)+AMP(8)-1D0/6D0*AMP(9)+AMP(10)-1D0/6D0*AMP(11)
     $ -1D0/6D0*AMP(12)+1D0/2D0*AMP(14)-1D0/6D0*AMP(15)+AMP(16)-1D0
     $ /6D0*AMP(17)+AMP(18)-AMP(19)-AMP(20)-AMP(21)-AMP(22)-AMP(23)
     ...
     $ -AMP(56)-AMP(57)-AMP(58)-AMP(59)-AMP(60)-AMP(61)+1D0/6D0*AMP(62)
     ...
     $ +1D0/2D0*AMP(9)+1D0/2D0*AMP(11)+1D0/2D0*AMP(12)+AMP(13)-1D0/6D0
     $ *AMP(14)+1D0/2D0*AMP(15)+1D0/2D0*AMP(17)-1D0/2D0*AMP(62)-1D0
     $ /2D0*AMP(63)-1D0/2D0*AMP(64)-1D0/2D0*AMP(65)-1D0/2D0*AMP(66)
     ...
     $ )
      AMP2(62)=AMP2(62)+(AMP(62)+AMP(63)+AMP(64)+AMP(65)+AMP(66))
     $ *DCONJG(AMP(62)+AMP(63)+AMP(64)+AMP(65)+AMP(66))
      AMP2(67)=AMP2(67)+(AMP(67)+AMP(68)+AMP(69)+AMP(70)+AMP(71)
     $ +AMP(72)+AMP(73)+AMP(74)+AMP(75)+AMP(76)+AMP(77)+AMP(78)+AMP(79)
     $ )*DCONJG(AMP(67)+AMP(68)+AMP(69)+AMP(70)+AMP(71)+AMP(72)+AMP(73)
