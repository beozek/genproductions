...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,21))
...
C     Amplitude(s) for diagram number 43
      CALL FFFF4_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_67,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFFF4_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_68,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFFF17_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_91,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFFF18_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_117,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFFF18_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_116,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFFF17_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_92,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFFF4_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_70,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFFF4_0(W(1,4),W(1,6),W(1,1),W(1,2),GC_73,AMP(50))
...
C     Amplitude(s) for diagram number 71
      CALL FFFF4_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_67,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFFF4_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_68,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFFF17_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_91,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFFF18_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_117,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFFF18_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_116,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFFF17_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_92,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFFF4_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_70,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFFF4_0(W(1,6),W(1,3),W(1,1),W(1,2),GC_73,AMP(78))
      CALL FFV1_1(W(1,2),W(1,5),GC_6,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,1),W(1,6),W(1,7),GC_2,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,1),W(1,6),W(1,8),GC_2,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,1),W(1,6),W(1,9),GC_2,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,1),W(1,6),W(1,10),GC_2,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,1),W(1,6),W(1,11),GC_2,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV1_3_0(W(1,1),W(1,6),W(1,12),GC_264,GC_203,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_3_0(W(1,1),W(1,6),W(1,13),GC_264,GC_203,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV1_3_0(W(1,1),W(1,6),W(1,14),GC_264,GC_203,AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV1_3_0(W(1,1),W(1,6),W(1,15),GC_264,GC_203,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV1_3_0(W(1,1),W(1,6),W(1,16),GC_264,GC_203,AMP(88))
C     Amplitude(s) for diagram number 89
      CALL FFV1_3_0(W(1,1),W(1,6),W(1,17),GC_264,GC_203,AMP(89))
...
C     Amplitude(s) for diagram number 93
      CALL FFFF4_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_67,AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFFF4_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_68,AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFFF17_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_91,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFFF18_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_117,AMP(96))
C     Amplitude(s) for diagram number 97
      CALL FFFF18_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_116,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFFF17_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_92,AMP(98))
C     Amplitude(s) for diagram number 99
      CALL FFFF4_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_70,AMP(99))
C     Amplitude(s) for diagram number 100
      CALL FFFF4_0(W(1,4),W(1,3),W(1,1),W(1,6),GC_73,AMP(100))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -AMP(75)+1D0/6D0*AMP(76)-AMP(77)+1D0/6D0*AMP(78)
      JAMP(2,1)=+1D0/2D0*(-AMP(12)-AMP(13)-AMP(14)-AMP(16)-AMP(18)
